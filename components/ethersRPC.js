...
// export default function EthereumComponent({ provider }) {
...
//       try {
//         const fetchedChainId = await ethereumRpc.getChainId();
//         setChainId(fetchedChainId);

//         const fetchedAccounts = await ethereumRpc.getAccounts();
//         setAccounts(fetchedAccounts);

//         const fetchedBalance = await ethereumRpc.getBalance();
...
//     try {
//       const ethereumRpc = new EthereumRpc(provider);
//       const receipt = await ethereumRpc.sendTransaction();
...
//     try {
//       const ethereumRpc = new EthereumRpc(provider);
//       const signedMsg = await ethereumRpc.signMessage();
