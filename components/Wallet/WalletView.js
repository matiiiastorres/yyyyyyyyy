...
// import logo from '../public/noImg.png';
import axios from 'axios';
import { CHAINS_CONFIG } from '../Wallet/chains';
    ...
    <>
      <div className="content">
        ...
        {fetching ? (
          ...
          <Tabs defaultActiveKey="1" className="walletView" tabPosition="left">
            {items.map((item) => (
